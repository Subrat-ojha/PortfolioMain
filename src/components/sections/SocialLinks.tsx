...
function SocialLinks() {
  const socialLinks = [
    {
      name: "Twitter",
      username: "@iamsubratojha",
      src: TwitterLogo.src,
      alt: "Twitter",
      href: "https://twitter.com/iamsubratojha",
    },

    {
      name: "LinkedIn",
      username: "@Subrat-ojha",
      src: LinkedinLogo.src,
      alt: "LinkedIn",
      href: "https://www.linkedin.com/in/Subrat-ojha/",
    },
    {
      name: "GitHub",
      username: "@Subrat-ojha",
      src: GithubLogo.src,
      alt: "GitHub",
      href: "https://github.com/Subrat-ojha",
    },
    {
      name: "Dev.to",
      username: "@",
    ...
    },
    {
      ...
      alt: "DailyDev",
      href: "https://app.daily.dev/subrat",
    },
  ];
  return (
